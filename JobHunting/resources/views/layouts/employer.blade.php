                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li class="@yield('ManageJobs')"><a href="{{ route('Employer.ManageJobs') }}"><i class="fa fa-suitcase"></i>
                                                Manage Jobs</a></li>
                                        <li class="@yield('JobPost')"><a href="{{ route('Employer.JobPost') }}"><i class="fa fa-book-reader"></i>
                                                Post A Jobs</a></li>
                                        <li><a href="{{ route('Employer.Logout') }}"><i class="fa fa-share-square"></i>
                                                Logout</a></li>
                                    </ul>
                                </div>
