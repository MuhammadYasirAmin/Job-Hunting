        ...
        <div class="wt-bnr-inr-entry">
            <div class="banner-title-outer">
                <div class="banner-title-name">
                    <h2 class="wt-title">{{ $JobsList->jobs()->first()->Job_Title }}</h2>
                </div>
            </div>
            <!-- BREADCRUMB ROW -->
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="cabdidate-de-info">
                            ...
                            <div class="twm-job-self-info">
                                <div class="twm-job-self-top">
                                    ...
                                    <div class="twm-mid-content">
                                        ...
                                        <h4 class="twm-job-title">{{ $JobsList->jobs()->first()->Job_Title }} <span
                                                class="twm-job-post-duration">/ 1 days ago</span></h4>
                                        <p class="twm-job-address"><i
                                                class="feather-map-pin"></i>{{ $JobsList->jobs()->first()->Job_Address }}
                                        </p>
                                        <div class="twm-job-self-mid">
                                            <div class="twm-job-self-mid-left">
                                                <a href="{{ $JobsList->jobs()->first()->Job_Website }}"
                                                    class="twm-job-websites site-text-primary">Visit Website</a>
                                                <div class="twm-jobs-amount">Rs.
                                                    {{ number_format(intval($JobsList->jobs()->first()->Job_Salary)) }}
                                                    <span>/ Month</span>
                                                </div>
                                            </div>
                                            <div class="twm-job-apllication-area">Application ends:
                                                <span class="twm-job-apllication-date">
                                                    {{ date('M d, Y', strtotime($JobsList->jobs()->first()->Job_EDate)) }}</span>
                                            </div>
                                        </div>
                        ...
                        <p>{!! $JobsList->jobs()->first()->Job_Desc !!}
                        </p>
                            ...
                            <div class="row">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic1.jpg" title="Title 1"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic2.jpg" title="Title 2"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb ">
                                                    <a class="elem" href="images/gallery/pic3.jpg" title="Title 3"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic4.jpg" title="Title 4"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic5.jpg" title="Title 5"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic6.jpg" title="Title 6"
                                                        data-lcl-author=""
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic7.jpg" title="Title 7"
                                                        data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic1.jpg">
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic8.jpg" title="Title 8"
                                                        data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic2.jpg">
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb ">
                                                    <a class="elem" href="images/gallery/pic9.jpg" title="Title 9"
                                                        data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic3.jpg">
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic10.jpg"
                                                        title="Title 10" data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic4.jpg">
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic11.jpg"
                                                        title="Title 11" data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic5.jpg">
                                            ...
                                            <li>
                                                <div class="tw-service-gallery-thumb">
                                                    <a class="elem" href="images/gallery/pic12.jpg"
                                                        title="Title 12" data-lcl-author=""
                                                        data-lcl-thumb="images/gallery/thumb/pic6.jpg">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="video-section-first"
                                        ...
                                        <a href="https://www.youtube.com/watch?v=c1XNqw2gSbU"
                ...
                <div class="col-lg-4 col-md-12 rightSidebar">
                                    ...
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ date('MM d, Y', strtotime($JobsList->jobs()->first()->created_at)) }}
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->jobs()->first()->Job_Address }}</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->jobs()->first()->Job_Title }}</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->jobs()->first()->Job_Experience }} Year</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->jobs()->first()->Job_Qualification }} </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->jobs()->first()->Job_Gender }}</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">{{ $JobsList->CMP_Name }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">{{ $JobsList->CMP_Phone }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                    ...
                    {{-- <div class="twm-advertisment" style="background-image:url({{ asset('images/add-bg.jpg') }});">
