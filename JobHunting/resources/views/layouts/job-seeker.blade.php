                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12 rightSidebar m-b30">
                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-candidate-profile-pic">
                                    ...
                                    <img src="{{ asset('images/user-avtar/pic4.jpg') }}" alt="">
                                ...
                                <div class="twm-mid-content text-center">
                                    <a href="#" class="twm-job-title">
                                        <h4>{{ Auth::guard('JobSeeker')->user()->name }} </h4>
                                    </a>
                                    <p>IT Contractor</p>
                                </div>
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li><a href="candidate-jobs-applied.html"><i class="fa fa-suitcase"></i>
                                                Applied Jobs</a></li>
                                        <li><a href="{{ route('JobSeeker.Logout') }}"><i
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-12 m-b30">
                            ...
                            <div class="twm-right-section-panel site-bg-gray">
                                <div class="wt-admin-right-page-header">
                                    <h2>{{ Auth::guard('JobSeeker')->user()->name }}</h2>
                                    <p>IT Contractor</p>
                                </div>
                                {{ $slot }}
